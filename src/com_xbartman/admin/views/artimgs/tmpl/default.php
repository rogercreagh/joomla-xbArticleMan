...
/*******
 * @package xbartman
 * file administrator/components/com_xbartman/views/artimgs/tmpl/default.php
...
?>
<form action="<?php echo JRoute::_('index.php?option=com_xbartman&view=artimgs'); ?>" method="post" name="adminForm" id="adminForm">
						...
						<td class="has-context">
							<div class="pull-left">
								...
								<?php if ($canEdit || $canEditOwn) : ?>
									...
									<?php echo JRoute::_('index.php?option=com_xbartman&task=article.edit&id=' . $item->id).'&retview=artimgs';?>
