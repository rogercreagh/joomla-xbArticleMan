...
/*******
 * @package xbArtMan
 * file administrator/components/com_xbartman/views/artlinks/view.html.php
 ...
 class XbarticlemanViewArtlinks extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('XBARTMAN_ARTLINKS_TITLE'), 'stack article');
		...
		if ($user->authorise('core.create', 'com_xbartman')
			&& $user->authorise('cxbartman', 'com_xbartman')
